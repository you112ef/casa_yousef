...
class Program
{
    static void Main()
    {
        try
        {
            Console.WriteLine("Adding path_vis table to database...");
            Console.WriteLine();
            ...
            using (var connection = new SQLiteConnection(connectionString))
            {
                ...
                if (tableExists)
                {
                    Console.WriteLine("Table 'path_vis' already exists in the database.");
                ...
                Console.WriteLine();
                Console.WriteLine("Updated database structure:");
                Console.WriteLine("==========================");
